...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements com.karn.ws.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/SOAP_eclipse_deployable/hello";
    ...
    public com.karn.ws.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.karn.ws.HelloWorldImplPortBindingStub _stub = new com.karn.ws.HelloWorldImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.karn.ws.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.karn.ws.HelloWorldImplPortBindingStub _stub = new com.karn.ws.HelloWorldImplPortBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.karn.com/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.karn.com/", "HelloWorldImplPort"));
        }
